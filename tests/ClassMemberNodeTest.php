...
class ClassMemberNodeTest extends \PHPUnit_Framework_TestCase {
  ...
  public function testStatic() {
    ...
    $this->assertSame('public static $bar;', $a->parent()->getText());
    ...
    $this->assertSame('protected $baz;', $b->parent()->getText());
  }

  public function testVisibility() {
    $a = Parser::parseSnippet('class Foo { public $bar; }')->getBody()->firstChild()->getMembers()[0];
    $this->assertEquals('private $bar;', $a->setVisibility('private')->parent()->getText());
  }
}
