...
END;
    ...
    $this->assertInstanceOf('\Pharborist\ClassNode', $stuff[2]);
...
END;
    ...
    $this->assertInstanceOf('\Pharborist\ClassNode', $classes[0]);
    $this->assertEquals('A', $classes[0]->getName());
    $this->assertInstanceOf('\Pharborist\ClassNode', $classes[1]);
